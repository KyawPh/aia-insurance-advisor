    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-100 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between gap-4 mb-6 sm:mb-8">
          <div className="relative h-10 w-20 sm:h-14 sm:w-28">
            <Image
              src="/logo.png"
              alt="IA Pro Logo"
              fill
        ...
        >
          ...
          <Card className="shadow-md border-0">
            <CardHeader className="px-4 sm:px-6">
              <CardTitle className="text-xl sm:text-2xl font-light text-gray-900">
                Privacy Policy
              </CardTitle>
              <p className="text-xs sm:text-sm text-gray-500 mt-1">Last updated: {new Date().toLocaleDateString()}</p>
            </CardHeader>
            <CardContent className="prose prose-sm sm:prose-base prose-gray max-w-none px-4 sm:px-6">
              <div className="space-y-6 sm:space-y-8">
                {/* Disclaimer */}
                <div className="p-4 sm:p-6 bg-amber-50 rounded-lg border border-amber-200 mb-6 sm:mb-8">
                  <h2 className="text-base sm:text-lg font-medium text-amber-900 mb-2">Independent Platform Notice</h2>
                ...
                <section>
                  <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">Data Controller</h2>
                ...
                <section>
                  <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">1. Information We Collect</h2>
                  
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex items-start space-x-3">
                      <Eye className="h-4 sm:h-5 w-4 sm:w-5 text-red-600 mt-0.5 sm:mt-1 flex-shrink-0" />
                      <div>
                        <h3 className="text-base sm:text-lg font-medium text-gray-900 mb-1 sm:mb-2">Personal Information</h3>
                    ...
                    <div className="flex items-start space-x-3">
                      <Database className="h-4 sm:h-5 w-4 sm:w-5 text-red-600 mt-0.5 sm:mt-1 flex-shrink-0" />
                      <div>
                        <h3 className="text-base sm:text-lg font-medium text-gray-900 mb-1 sm:mb-2">Client Data</h3>
                        <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                    ...
                    <div className="flex items-start space-x-3">
                      <Lock className="h-4 sm:h-5 w-4 sm:w-5 text-red-600 mt-0.5 sm:mt-1 flex-shrink-0" />
                      <div>
                        <h3 className="text-base sm:text-lg font-medium text-gray-900 mb-1 sm:mb-2">Usage Information</h3>
                        <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">2. How We Use Your Information</h2>
                ...
                <section>
                  <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">3. Data Security</h2>
                  <div className="bg-gray-50 p-4 sm:p-6 rounded-lg border border-gray-200 mb-3 sm:mb-4">
                    <h3 className="text-base sm:text-lg font-medium text-gray-900 mb-2 sm:mb-3">Our Security Measures:</h3>
                ...
                <section>
                  <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">4. Data Sharing and Disclosure</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3 sm:mb-4">
                ...
                <section>
                  <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">5. Data Retention</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">6. Your Rights and Choices</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3 sm:mb-4">
                ...
                <section>
                  <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">7. Cookies and Tracking</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">8. Children's Privacy</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">9. International Data Transfers</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">10. Changes to This Policy</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
              ...
              <div className="mt-8 sm:mt-12 p-4 sm:p-6 bg-blue-50 rounded-lg border border-blue-100">
                <h3 className="text-base sm:text-lg font-medium text-blue-900 mb-1 sm:mb-2">Your Trust is Important to Us</h3>
