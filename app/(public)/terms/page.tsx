          ...
          <Card className="shadow-md border-0">
            ...
            <CardContent className="prose prose-sm sm:prose-base prose-gray max-w-none px-4 sm:px-6">
              <div className="space-y-6 sm:space-y-8">
                ...
                <section>
                  <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">3. User Responsibilities</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3 sm:mb-4">
                ...
                <section>
                  <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">4. Data Privacy and Security</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">5. Limitations of Liability</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">6. Intellectual Property</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">7. Service Availability</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">8. Modifications to Terms</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">9. Termination</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">10. Contact Information</h2>
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
              ...
              <div className="mt-8 sm:mt-12 p-4 sm:p-6 bg-red-50 rounded-lg border border-red-100">
